...
import com.beshanov.meetupapp.apigatewayservice.models.response.EventListResponse;
...
public class EventsController {
    ...
    public List<EventMock> getMyEvents() {
        ...
        GetMyEventsIdsResponse eventsIds = restTemplate.getForObject("http://localhost:8081/events/?userId=" + userId, GetMyEventsIdsResponse.class);
        ...
        EventListResponse listEventsResponse = restTemplate2.postForObject("http://localhost:8082/events/", eventsRequest, EventListResponse.class);
